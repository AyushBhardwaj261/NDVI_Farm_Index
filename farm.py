...
def main():
    ...
    # cv2.imshow("output4",smoothImg(img_raw))
    # cv2.imshow("output5",binarizeSmImg(img_raw))
    # cv2.imshow("output6",cropImg(img_raw))
    # cv2.imshow("output7",rotateNdArray(img_raw))
    # cv2.imshow("output8",rotateBinNdArray(img_raw))
    # cv2.imshow("output9",find_peaks(img_raw))
    # cv2.imshow("output10",pltImShow(img_raw))
    # cv2.imshow("output11",pltImShowMulti(img_raw))
    # cv2.imshow("output12",getRGBQImg(img_raw))
    # cv2.imshow("output13",getBinQImg(img_raw))
    # cv2.imshow("output14",getIdx8QImg(img_raw))
    # cv2.imshow("output15",getGrayQImg(img_raw))
